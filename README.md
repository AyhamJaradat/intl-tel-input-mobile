...
## Getting Started
1. Download the [latest release](https://github.com/MohamedMardona/intl-tel-input-mobile.git), or better yet install it with [npm](https://www.npmjs.com/package/intl-tel-input-mobile)
